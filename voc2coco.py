...
if __name__ == '__main__':
    # xml标注文件夹
    xml_dir = 'F:\\YOLO v3 data\\keras-yolo3\\VOCdevkit\\DIOR+TGRS\\Annotation'
    # 训练数据的json文件
    save_json_train = 'F:\\YOLO v3 data\\keras-yolo3\\VOCdevkit\\DIOR+TGRS\\train.json'
    # 验证数据的json文件
    save_json_val = 'F:\\YOLO v3 data\\keras-yolo3\\VOCdevkit\\DIOR+TGRS\\val.json'

    # 类别，这里只有一个类别，如果是多个类别，往classes中添加类别名字即可，比如['dog', 'person', 'cat']
    classes = ['harbor']

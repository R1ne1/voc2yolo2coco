...
anno = "F:\\YOLO v3 data\\keras-yolo3\\VOCdevkit\\DIOR+TGRS\\train.json" # 待转换的json格式文件路径
xmldir = "F:\\YOLO v3 data\\keras-yolo3\\VOCdevkit\\DIOR+TGRS\\annotations\\" # 转为xml格式后的保存路径
